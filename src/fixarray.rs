...
pub(crate) struct FixArray<T, const SIZE: usize>([T; SIZE]);

pub(crate) type FloatArray<const SIZE: usize> = FixArray<f32, SIZE>;
pub(crate) type IntArray<const SIZE: usize> = FixArray<u32, SIZE>;
...
mod tests {
    ...
    fn sample_check<const SIZE: usize>(weights: [f32; SIZE]) {
        ...
        let mut rng = SmallRng::seed_from_u64(0b101010001100011101010110001111); // Doc says that SmallRng should have enough 1 in seed
